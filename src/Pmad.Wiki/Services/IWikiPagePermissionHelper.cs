...
public interface IWikiPagePermissionHelper
{
    ...
    Task<List<WikiPageInfo>> GetAllAccessiblePagesAsync(IWikiUserWithPermissions? wikiUser, CancellationToken cancellationToken = default);
    ...
    Task<List<WikiPageInfo>> GetAccessibleSubPagesAsync(IWikiUserWithPermissions? wikiUser, string pageName, bool recursive = true, CancellationToken cancellationToken = default);
